...
cor_plot <- ggscatter(eye_size_estimates, x = 'rel_mean_AD', y = 'rel_mean_eye_size', 
          ...
          xlab = "Relative eye size estimates using Ausprey & Stanley 2024", ylab = "Relative eye size estimates using eBird", col = 'black', shape = 20, size = 5, label = 'scientific_name' , font.label = c(15, 'black'), 
