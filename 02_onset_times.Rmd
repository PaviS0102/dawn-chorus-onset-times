...
eye_size_ebird <- read.csv ("results/eye_size_residuals.csv")
```
...
winter_rel_onset_times <- winter_rel_onset_times %>%
  left_join (., eye_size_ebird, by = c('scientific_name', 'common_name')) %>%
  dplyr::select (species, median_begin_time, median_relative_onset_time, scientific_name, common_name, Order, eBird_codes, ebird_residuals, q1, q3) 
```
