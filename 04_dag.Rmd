...
myDag <- dagitty ('dag {
bb="-4.34,-3.62,3.623,6.047"
Body_Mass [pos="-3.490,0.154"]
Eye_Size [pos="-0.136,0.101"]
Foraging_Height [pos="2.192,-0.930"]
Peak_Frequency [pos="-3.676,-2.650"]
Territoriality [pos="2.959,5.241"]
Trophic_Niche [pos="1.720,-2.814"]
Vegetation_Structure [pos="-0.609,-2.549"]
onset_times_wrt_time_or_light [outcome,pos="1.036,3.214"]
Body_Mass -> Eye_Size
Body_Mass -> Peak_Frequency
Eye_Size -> onset_times_wrt_time_or_light
Foraging_Height -> Eye_Size
Territoriality -> onset_times_wrt_time_or_light
