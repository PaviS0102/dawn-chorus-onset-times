...
dag <- dagify ('onset_times_wrt_time_or_light' ~ 'Territoriality' + 'Peak_Frequency' + 'Eye_Size' + 'Light' + 'Vegetation_Structure' + 'Season', 
              'Territoriality' ~ 'Communal_Signalling',
              'Peak_Frequency' ~ 'Body_Mass' + 'Vegetation_Structure',
              #'Light' ~ 'Vegetation_Structure' + 'Season',
              'Eye_Size' ~ 'Body_Mass' + 'Vegetation_Structure' + 'Trophic_Niche' + 'onset_times_wrt_time_or_light', 
              'Foraging_Height' ~ 'Vegetation_Structure' + 'onset_times_wrt_time_or_light' + 'Trophic_Niche',
...
adjustmentSets(dag, exposure = "Trophic_Niche", outcome = "onset_times_wrt_time_or_light") #eye size
adjustmentSets(dag, exposure = "Territoriality", outcome = "onset_times") #none
adjustmentSets(dag, exposure = "Foraging_Height", outcome = "onset_times") #Eye Size * Light * Peak Frequency + Body Mass * Eye Size * Light + Light * Trophic Niche * Vegetation Structure
...
adjustmentSets(dag, exposure = "Peak_Frequency", outcome = "onset_times") #Eye Size * Light  + Body Mass
